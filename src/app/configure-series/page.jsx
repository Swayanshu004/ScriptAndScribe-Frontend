...
function page(){
    ...
    const [selectedBookcount, setSelectedBookcount] = useState("Select Number of Books");
    ...
    const [isOpennumofbook, setIsOpennumofbook] = useState(false);
    ...
    return (
        <div className='h-fit px-10 py-10 bg-amber-100'>
            <h2 className="text-amber-950 text-3xl font-medium border-b-[1px] border-amber-900 mb-10">Configure Your Series</h2>
                    ...
                    <form className="h-full flex flex-col items-center justify-around">
                        ...
                        <div className="relative w-5/6 mb-10">
                            <button
                                type="button"
                                name="pagecount"
                                onClick={() => setIsOpennumofbook(!isOpennumofbook)}
                                className="w-full flex items-center justify-between px-4 py-2 bg-amber-100 border-[1px] border-amber-950 focus:border-[3px]"
                            >
                                {selectedBookcount}
                            </button>
                            {isOpennumofbook && (
                                <ul className="absolute w-full bg-amber-50 border border-amber-900 shadow-md z-10">
                                {bookcount.map((option, index) => (
                                    <li
                                    key={index}
                                    onClick={() => {
                                        setSelectedBookcount(option);
                                        setIsOpennumofbook(false);
                                    }}
                                    className="px-4 py-2 hover:bg-amber-900  hover:text-amber-100 cursor-pointer"
                                    >
                                    {option}
