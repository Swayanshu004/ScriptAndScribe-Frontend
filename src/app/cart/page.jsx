  ...
  return (
    <div>
        <div className={`${forum.className} min-h-screen px-10 bg-amber-100`}>
            ...
            <div className='bg-neutral-50 w-full h-fit p-5 flex items-start justify-between my-5'>
                <Image 
                ...
                <div className='w-1/6'>
                    ...
                    <div className='w-1/3 flex items-center justify-between'>
                        <button className='border-[1px] border-amber-950 w-6 rounded-full hover:bg-amber-950 hover:text-white'>-</button>
                        <p>2</p>
                        <button className='border-[1px] border-amber-950 w-6 rounded-full hover:bg-amber-950 hover:text-white'>+</button>
                    </div>
                </div>
