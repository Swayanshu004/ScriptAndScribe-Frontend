        ...
        <nav className={`${forum.className} flex flex-col md:flex-row items-center justify-between w-screen px-10 py-3 bg-amber-100`}>
            ...
            <div className="">
                <ul className="flex items-center gap-5 font-medium text-lg">
                    <li className="px-3 rounded-full ease-in-out hover:-translate-y-1.5 hover:font-bold duration-500"><Link href="/store">Store</Link></li>
                    ...
                    <li className="px-3 rounded-full ease-in-out hover:-translate-y-1.5 hover:font-bold duration-500"><Link href="/book">Book</Link></li>
